<template>
  <div class="home">
    ...
    <div class="createCompanyForm wh-form" v-if="formSection == 'createCompany' ">
      ...
      <input type="text" id="orgName" v-model="orgName" name="organisationName" placeholder="Enter name of organisation." autocomplete="off"><br><br>

      <label for="organisationDomain">Domain: </label><br>
      <input type="text" id="orgDomain" v-model="orgDomain" name="organisationDomain" placeholder="Enter domain for organisation." autocomplete="off"><br><br>
      <button class="submitBtn" v-on:click="createOrganisation()"> SUBMIT</button>
    </div>

    <!-- Creating organisation step 2 : create warehouse -->

    <div class="createWarehouseForm wh-form" v-if="formSection == 'createWarehouse' ">
      <div class="formHeader">
      ...
      <input type="text" id="wh-Name" v-model="whName" name="warehouseName" placeholder="Enter an alias for warehouse." autocomplete="off"><br><br>



      <label for="addAisle">Add aisle: {{ aisleCount }} </label><br>
        <input type="number"  v-for="el in aisleCount" class="aisleNumber" :key="el" placeholder="Enter location quantity">
...
export default {
  ...
  methods: {
    ...
    createWarehouse : function(){
      ...
      tempArray.map(el => {
        if(el.value != "") 
          data.aisle.push({"location_qty": el.value})
      })
      console.log(data)
    }
  }
